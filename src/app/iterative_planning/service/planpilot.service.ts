...
export type PlanPilotQueryType = 'facets' | 'facetCount' | 'facetReduction' | 'solution' | 'solutionCount' | 'solutionReduction';
...
export class PlanPilotService {
  ...
  startSession$(request: StartPlanPilotSessionRequest): Observable<PlanPilotSessionResponse> {
  ...
  listFacets$(runId: string): Observable<PlanPilotFacetListResponse> {
    return this.http.post<PlanPilotFacetListResponse>(`${this.baseUrl}/${runId}/facets/list`, {});
  }

  applyFacets$(runId: string, request: ApplyPlanPilotFacetsRequest): Observable<PlanPilotFacetListResponse> {
    return this.http.post<PlanPilotFacetListResponse>(`${this.baseUrl}/${runId}/facets/apply`, request);
  }

  query$(runId: string, type: PlanPilotQueryType, solutionNumber?: number): Observable<PlanPilotQueryResponse> {
    return this.http.post<PlanPilotQueryResponse>(`${this.baseUrl}/${runId}/query`, {
      type,
  ...
  stopSession$(runId: string): Observable<StopPlanPilotSessionResponse> {
    return this.http.delete<StopPlanPilotSessionResponse>(`${this.baseUrl}/${runId}`);
  }
}
