...
import { PlanProperty, PlanPropertyBase } from "../../shared/domain/plan-property/plan-property";
...
export class PlanPropertyService{
    ...
    postPlanProperty$(planProperty: PlanPropertyBase): Observable<PlanProperty> {
