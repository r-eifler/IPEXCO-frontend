...
export const loadProjectFailure = createAction('[iterative-planning] load project failure', props<{ err: any}>());
...
export const loadDomainSpecificationFailure = createAction('[iterative-planning]  load  domain specification failure', props<{ err: any}>());
...
export const updatePlanPropertyFailure = createAction('[iterative-planning] update plan property failure', props<{ err: any}>());
...
export const deletePlanPropertyFailure = createAction('[iterative-planning] delete plan property failure', props<{ err: any}>());
...
export const loadIterationStepsFailure = createAction('[iterative-planning] load iteration steps failure', props<{ err: any}>());
...
export const createIterationStepFailure = createAction('[iterative-planning] create iteration steps failure', props<{ err: any}>());
...
export const deleteIterationStepFailure = createAction('[iterative-planning] delete iteration step failure', props<{ err: any}>());
...
export const registerPlanComputationFailure = createAction('[iterative-planning] register plan computation failure', props<{ err: any}>());
...
export const planComputationRunningFailure = createAction('[iterative-planning] plan computation running failure', props<{ err: any}>());
...
export const cancelPlanComputationAndIterationStepFailure = createAction('[iterative-planning] cancel plan computation and iteration step failure', props<{ err: any}>());
...
export const registerGlobalExplanationComputationFailure = createAction('[iterative-planning] register global explanation computation failure', props<{ err: any}>());
...
export const globalExplanationComputationRunningFailure = createAction('[iterative-planning] global explanation computation running failure', props<{ err: any}>());
...
export const explanationComputationRunningFailure = createAction('[iterative-planning] explanation computation running failure', props<{ err: any}>());
