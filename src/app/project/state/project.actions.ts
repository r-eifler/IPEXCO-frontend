...
export const loadProjectFailure = createAction('[project] load project failure',  props<{err: any}>());
...
export const updateProjectFailure = createAction('[project] update project failure',  props<{err: any}>());
...
export const loadDomainSpecificationFailure = createAction('[project] load  domain specification failure',  props<{err: any}>());
...
export const loadPlanPropertiesFailure = createAction('[project] load plan properties failure',  props<{err: any}>());
...
export const createPlanPropertyFailure = createAction('[project] create plan property failure',  props<{err: any}>());
...
export const updatePlanPropertyFailure = createAction('[project] update plan property failure',  props<{err: any}>());
...
export const deletePlanPropertyFailure = createAction('[project] delete plan property failure',  props<{err: any}>());


// demos

export const updateDemo = createAction('[project] update demo', props<{id: string, demo: DemoBase}>());
export const updateDemoSuccess = createAction('[project] update demo success', props<{demo: Demo}>());
export const updateDemoFailure = createAction('[project] update demo failure',  props<{err: any}>());
...
export const loadProjectDemosFailure = createAction('[project] load project demos failure',  props<{err: any}>());
...
export const uploadProjectDemoImageFailure = createAction('[project] upload project demo image failure',  props<{err: any}>());
...
export const registerDemoCreationFailure = createAction('[project] register demo creation failure',  props<{err: any}>());
...
export const cancelDemoCreationFailure = createAction('[project] cancel demo creation failure',  props<{err: any}>());
...
export const demoCreationRunningFailure = createAction('[project] demo creation running failure',  props<{err: any}>());
...
export const deleteProjectDemoFailure = createAction('[project] delete project demos failure',  props<{err: any}>());
...
export const loadDemoPlanPropertiesFailure = createAction('[project] load demo plan properties failure',  props<{err: any}>());
...
// export const loadProjectDemoFailure = createAction('[project] load project demo failure',  props<{err: any}>());


// services
export const loadServices = createAction('[project] load  services');
export const loadServicesSuccess = createAction('[project] load  services success', props<{services: Service[]}>());
export const loadServicesFailure = createAction('[project] load  services failure',  props<{err: any}>());
...
export const loadPromptsFailure = createAction('[project] load  prompts failure',  props<{err: any}>());
...
export const loadOutputSchemasFailure = createAction('[project] load  output schemas failure',  props<{err: any}>());
