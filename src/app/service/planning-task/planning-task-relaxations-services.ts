...
export class PlanningTaskRelaxationService extends ObjectCollectionService<PlanningTaskRelaxationSpace> {
  ...
  findCollection(queryParams: QueryParam[] = []) {
    ...
    this.http
      .get<IHTTPData<PlanningTaskRelaxationSpace[]>>(this.BASE_URL, {
        params: httpParams,
      })
  ...
  saveObject(object: PlanningTaskRelaxationSpace) {
    ...
    if (object._id) {
      return this.http
        .put<IHTTPData<PlanningTaskRelaxationSpace>>(
          this.BASE_URL + object._id,
          { data: object }
        )
        .subscribe((httpData) => {
    ...
    return this.http
      .post<IHTTPData<PlanningTaskRelaxationSpace>>(this.BASE_URL, {
        data: object,
      })
      .subscribe((httpData) => {
