...
export const loadUserStudiesFailure = createAction('[UserStudy] load user studies failure',  props<{err: any}>());
...
export const createUserStudyFailure = createAction('[UserStudy] create user study failure',  props<{err: any}>());
...
export const loadUserStudyFailure = createAction('[UserStudy] load user study failure',  props<{err: any}>());
...
export const editUserStudyFailure = createAction('[UserStudy] edit user study failure',  props<{err: any}>());
...
export const deleteUserStudyFailure = createAction('[UserStudy] delete user study failure',  props<{err: any}>());
...
export const loadUserStudyParticipantsFailure = createAction('[UserStudy] load user study participants failure',  props<{err: any}>());
...
export const acceptUserStudyParticipantFailure = createAction('[UserStudy] accept user study participant failure',  props<{err: any}>());
...
export const loadParticipantDistributionsFailure = createAction('[UserStudy] load user study participant distributions failure',  props<{err: any}>());
...
export const createParticipantDistributionFailure = createAction('[UserStudy] create user study participant distribution failure',  props<{err: any}>());
...
export const loadParticipantDistributionFailure = createAction('[UserStudy] load user study participant distribution failure',  props<{err: any}>());
...
export const editParticipantDistributionFailure = createAction('[UserStudy] edit user study participant distribution failure',  props<{err: any}>());
...
export const deleteParticipantDistributionFailure = createAction('[UserStudy] delete user study participant distribution failure',  props<{err: any}>());