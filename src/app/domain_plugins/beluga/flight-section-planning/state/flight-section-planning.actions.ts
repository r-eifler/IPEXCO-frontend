...
export const createSuccessorFlightsHorizon = createAction('[beluga-flights-horizon-planning] create successor flights horizon', props<{section: FlightsHorizon, horizon: number[]}>());
