...
export const loadDemosFailure = createAction('[demo] load  demos failure', props<{ err: any}>());
...
export const deleteDemoFailure = createAction('[demo] delete  demos failure', props<{ err: any}>());
...
export const loadDemoPlanPropertiesFailure = createAction('[demo] load demo plan properties failure', props<{ err: any}>());
...
export const loadDemoFailure = createAction('[demo] load  demo failure', props<{ err: any}>());
...
export const updateDemoFailure = createAction('[demo] update demo failure', props<{ err: any}>());
...
export const uploadDemoFailure = createAction('[demo] upload demo failure', props<{ err: any}>());
...
export const updatePlanPropertyFailure = createAction('[demo] update plan property failure', props<{ err: any}>());
...
export const loadDomainSpecificationFailure = createAction('[demo] load  domain specification failure', props<{ err: any}>());
...
export const loadServicesFailure = createAction('[demo] load  services failure', props<{ err: any}>());
...
export const loadPromptsFailure = createAction('[demo] load  prompts failure', props<{ err: any}>());
...
export const loadOutputSchemasFailure = createAction('[demo] load  output schemas failure', props<{ err: any}>());
