...
export const loadProjectMetaDataListFailure = createAction('[project-meta] load project meta data list failure', props<{err: any}>());
...
export const createProjectFailure = createAction('[project-meta] create new project failure', props<{err: any}>());
...
export const deleteProjectFailure = createAction('[project-meta] delete project failure', props<{err: any}>());
